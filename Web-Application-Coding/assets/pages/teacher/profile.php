<?php 
    ...
    $user_info = $obj->Requete("SELECT * FROM user u, professeur p WHERE p.ID_USER = u.ID_USER AND u.ID_USER = '".$_SESSION["ID_USER"]."'")->fetch();
    ...
    if(isset($_POST['update_user_info'])):
        $requete = $obj->Update('professeur' , ['NOM_PROF' , 'PRENOM_PROF' , 'EMAIL_PROF' , 'TELEPHONE_PROF' , 'CNIB_PROF'] , [$_POST['last_name'] , $_POST['first_name'] , $_POST['email'] , $_POST['phone'] , $_POST['cnib']],array('ID_USER'=>$_SESSION["ID_USER"]));
        ...
        <div class="col-lg-4">
            <div class="card shadow">
                ...
                <div class="card-body text-center">
                    <h5 class="card-title h6"><strong>Full name : </strong><?=$user_info['NOM_PROF']." ".$user_info['PRENOM_PROF']?></h5>
                    <p class="card-text"><strong>Email : </strong> <?=$user_info['EMAIL_PROF']?></p>

                    <div class="btn-group" role="group">
                        <a class="btn btn-dark rounded-circle mx-2" href="<?='tel:'.$user_info['TELEPHONE_PROF']?>"><i class="text-white fas fa-phone"></i></a>  
                        <a class="btn btn-dark rounded-circle mx-2" href="<?='mailto:'.$user_info['EMAIL_PROF']?>"><i class="text-white fab fa-google-plus-g"></i></a> 
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="first_name" id="first_name" value="<?=$user_info['PRENOM_PROF']?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="last_name" id="last_name" value="<?=$user_info['NOM_PROF']?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 my-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="cnib" id="cnib" value="<?=$user_info['CNIB_PROF']?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" name="email" id="email" value="<?=$user_info['EMAIL_PROF']?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" class="form-control" name="phone" id="phone" value="<?=$user_info['TELEPHONE_PROF']?>">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input oninput="verifer(this.value)"  type="text" class="form-control" name="username" id="username" value="<?= $user_info["USERNAME"] ?>">
