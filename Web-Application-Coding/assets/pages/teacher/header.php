<?php
    ...
    $user_inf = $obj->Requete("SELECT u.PROFILE_PIC FROM user u, professeur p WHERE p.ID_USER = u.ID_USER AND u.ID_USER = '".$_SESSION["ID_USER"]."'")->fetch();
...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../../simplebar/src/simplebar.css">
        <!-- ---------- Bootstrap css --------- -->
        ...
        <link rel="stylesheet" href="../../library/DataTable/css/bootstrap-editable.css">        
        ...
        <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item no-arrow align-items-center justify-content-center" id="userInfo">
                <a class="nav-link d-block" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="img-profile rounded-circle mx-auto d-block" src="<?='..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'media'.DIRECTORY_SEPARATOR.$user_inf['PROFILE_PIC'] ?>" width="200px" height="200px">
                    <span>
            ...
            <div id="fixeHeight" data-simplebar>
                <!-- Divider -->
                ...
                <!-- Divider -->
                <h4 class="sidebar-heading mt-3">Marks Management</h4>
                <hr class="sidebar-divider">

                <?php menu_item_collapse('Test', '#', 'fas fa-pen-alt', ["plan_test.php", "planned_test.php"], ["Plan a test", "Planned Test"]); ?>

                <?= menu_item("Marks", "report_marks.php", "fas fa-pencil-ruler"); ?>
                

                <!-- Divider -->
                <h4 class="sidebar-heading mt-3">Course Management</h4>
                <hr class="sidebar-divider">
            </div>
