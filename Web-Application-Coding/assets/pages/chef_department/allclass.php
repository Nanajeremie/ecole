                    ...
                    <div class="card-body py-2">
                        <table id="table" class="table table-bordered table-hover table-responsive-lg table-responsive-md table-responsive-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-truncate">Field/Department</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-truncate"><?= $backListe['NOM_FILIERE'] ?>/<span class="text-info"><?= $backListe['NOM_DEPARTEMENT'] ?></span></td>
                        ...
                        <div class="modal fade" id="new_class" data-backdrop="static" data-keyboard="false"
                            ...
                            <div class="modal-dialog modal-xl" role="document">
                                <div class="modal-content">
                                    <div class="modal-header bg-primary">
                                        <h5 class="modal-title bg-white">Add New Class</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                                                onclick="loads()">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
