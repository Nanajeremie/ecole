                            ...
                            <form action="" method="post">
                                ...
                                <!-- Education Background -->
                                    ...
                                    <div class="col-lg-4 p-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="inscription_tel" id="inscription_tel" class="form-control" value="<?= $the_new_student['TELEPHONE']; ?>" readonly>
                                            <div class="input-group-append">
                                    ...
                                    <div class="col-lg-4 p-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="inscription_tel_urg" id="inscription_tel_urg" class="form-control" value="<?=$the_new_student['NUM_URGENCE']; ?>" readonly>
                                            <div class="input-group-append">
