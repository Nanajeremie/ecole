                    ...
                    ?>
                        <table class="table table-bordered table-hover table-responsive table-responsive-md table-responsive-lg" id="table">
                            ...
                            while ($new_student=$all_new_student->fetch()){
                                ...
                                ?>
                                <tr>
                                    <td class="text-truncate"><a href="meeting.php?id=<?= $new_student['ID_NEW_ETUDIANT'] ?>" class="btn btn-primary text-truncate">Start Meeting</a>
                                    </td>
                                    <td class="text-truncate"><?= $date_time['DATE_ENTRETIEN']; ?></td>
                                    <td class="text-truncate"><?= $date_time['HEURE'];  ?></td>
                                    <td class="text-truncate text-uppercase"><?=$new_student['NOM']; ?></td>
