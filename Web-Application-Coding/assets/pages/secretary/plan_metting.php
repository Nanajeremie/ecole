                                    ...
                                    <tr>
                                        <td class="text-uppercase">
                                            <div class="btn-group" role="group" aria-label="Button group">
                                                <button class="btn btn-primary text-truncate" data-toggle="modal" onclick="rename_input_plan_meeting(this.title)" title="<?= $new_student['ID_NEW_ETUDIANT'] ?>" data-target="<?= '#' . $meeting ?>">Plan meeting </button>
                                            </div>
                                        </td>
