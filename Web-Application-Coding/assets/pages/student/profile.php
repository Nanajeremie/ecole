<?php 
    ...
    $user_info = $obj->Requete("SELECT * FROM user u, etudiant e , inscription i WHERE e.ID_USER = u.ID_USER AND e.MATRICULE = i.MATRICULE AND u.ID_USER = '".$_SESSION["ID_USER"]."'")->fetch();
    ...
    if(isset($_POST['update_user_info'])):
        $requete = $obj->Update('etudiant' , ['NOM' , 'PRENOM' , 'EMAIL' , 'TELEPHONE' , 'CNIB' , 'NUM_URGENCE' , 'PROFESSION_PERE' , 'PROFESSION_MERE'],[$_POST['first_name'] , $_POST['last_name'] , $_POST['email'] , $_POST['phone'] , $_POST['cnib'] , $_POST['urgence'] , $_POST['prof_pere'] , $_POST['prof_mere']] , array('ID_USER'=>$_SESSION["ID_USER"]));
            ...
            <div class="card shadow">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="btn-group" role="group">
                        <a class="btn btn-dark rounded-circle mx-2" href="<?='tel:'.$user_info['TELEPHONE']?>"><i class="text-white fas fa-phone"></i></a>  
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 my-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="cnib" id="cnib" value="<?=$user_info['CNIB']?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 my-3">
                                        <div class="form-group">
                                            <label for="prof_pere">Father Job <span class="text-danger">  </span></label>
                                            <input type="text" class="form-control" name="prof_pere" id="prof_pere" value="<?=$user_info['PROFESSION_PERE']?>">
                                        </div>
                                    </div>

                                    <div class="col-lg-6 my-3">
                                        <div class="form-group">
                                            <label for="prof_mere">Mother Job <span class="text-danger">  </span></label>
                                            <input type="text" class="form-control" name="prof_mere" id="prof_mere" value="<?=$user_info['PROFESSION_MERE']?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 my-3">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" class="form-control" name="phone" id="phone" value="<?=$user_info['TELEPHONE']?>">
                                        </div>
                                    </div>

                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="urgence">Emergency Number <span class="text-danger"> * </span></label>
                                            <input type="tel" class="form-control" name="urgence" id="urgence" value="<?=$user_info['NUM_URGENCE']?>">
                                        </div>
                                    </div>
