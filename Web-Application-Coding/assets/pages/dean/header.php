    ...
    <div id="fixeSideBar">
        <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div id="fixeHeight" class="comment-scrollbar">
                ...
                <!-- Nav Item - Meetings -->
                <?php menu_item_collapse('Meetings', '#', 'fas fa-handshake', ['attribute_scholarship.php', 'plan_metting.php', 'all_plan_meeting.php'], ['All Meetings(Dean)', 'Plan Meeting(Secretary)', 'All Planned Meetings']); ?>

                <!-- Divider -->
                <h4 class="sidebar-heading mt-3">Tuition Management</h4>
                <hr class="sidebar-divider">

                <!-- Nav Item - Scholarship -->
                <?php menu_item_collapse('Scholarship', '#', 'fas fa-money-bill', ['scholarship.php', 'scholarship_owners.php'], ['Sholarships', 'Owners']); ?>


                <!-- Nav Item - Tuitions -->
                <li class='nav-item'>
                    <a class='nav-link collapsed' href='#' data-toggle='collapse' data-target='#links' aria-expanded='true'
                    aria-controls='links'>
                    ...
                    <?php
                        ...
                        function active(string $lien): string
                        {
                    ...
                    <div id='links' class='<?= $deroulante ?>' aria-labelledby='headingUtilities'
                        ...
                        <div class='bg-white py-2 collapse-inner rounded'>
                            ...
                            <a class='<?= active('inscription_valide.php') ?>' href='inscription_valide.php'>New Students</a>
                            <a class='<?= active('old-student-tuition.php') ?>' href='old-student-tuition.php'>Reinscription</a>

                            <h4 class="sidebar-heading text-secondary mt-3">Other Payments</h4>
                            <hr class="sidebar-divider bg-secondary">
                            <a class='<?= active('valide_other_paiement.php') ?>' href='valide_other_paiement.php'>Pay
                                tuitions</a>

                            <h4 class="sidebar-heading text-secondary mt-3">Payment Statistics</h4>
                            <hr class="sidebar-divider bg-secondary">
                            <a class='<?= active('list-payment.php') ?>' href='list-payment.php?page=list-payment'>List all Payment</a>
                        </div>
                    </div>
                </li>
