<?php 
    ...
    if(isset($_POST["update_auth_info"])):
        if($user_info['PASSWORD']==$_POST['old_password']){
            if($_POST['new_password']==$_POST['re_password']){
                $obj->Update('user',['PASSWORD','USERNAME'],[$_POST['new_password'],$_POST['username']],array('ID_USER'=>$_SESSION["ID_USER"]));
    ...
    if(isset($_POST['update_user_info'])):
        $obj->Update('administration',['NOM','PRENOM','EMAIL','PHONE'],[$_POST['first_name'],$_POST['last_name'],$_POST['email'],$_POST['phone']],array('ID_USER'=>$_SESSION["ID_USER"]));
        Redirect('profile.php');
    endif;
