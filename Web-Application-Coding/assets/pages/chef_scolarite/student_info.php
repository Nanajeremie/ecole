                        ...
                        <div class="row">
                                ...
                                <div class="col-lg-12 text-left my-2">
                                    ...
                                    <div class="col-lg-4 p-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="matricule" id="matricule" class="form-control" value="<?= $student_info['MATRICULE'] ?>" required>
                                        </div>
                                    </div>
                            ...
                            <!-- Meeting Information -->
                                <div class="col-lg-12 text-left my-2">
                                    ...
                                    <div class="col-lg-6 p-4">
                                        <label for="moth_job" class="pb-3">Recommendation</label>
                                        <div class="input-group">
                                            <input type="text" name="moth_job" id="moth_job" class="form-control" value="<?= $student_info['RECOMMENDATION'] ?>" required>
                                            <div class="input-group-append">
                                                <span class=" input-group-text fas fa-user bg-light"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6 p-4">
                                        <label for="scholar" class="pb-3">Scholarship</label>
                                        <div class="input-group">
                                            <input type="text" name="scholar" id="scholar" class="form-control" value="<?= $student_motivation['TAUX'] .' %'?>" disabled required>
                                            <div class="input-group-append">
                                    ...
                                    <div class="col-lg-6 p-4">
                                        <label for="scholar" class="pb-3">School Fees</label>
                                        <div class="input-group">
                                            <input type="text" name="scholar" id="scholar" class="form-control" value="<?= $school_fees['MONTANT_TOTAL'] .' fcfa'?>" disabled required>
                                            <div class="input-group-append">
                                                <span class=" input-group-text fas fa-money-bill bg-light"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6 p-4">
                                        <label for="scholar" class="pb-3">Already payed</label>
                                        <div class="input-group">
                                            <input type="text" name="scholar" id="scholar" class="form-control" value="<?= $school_fees['MONTANT_PAYE'] .' fcfa'?>" disabled required>
                                            <div class="input-group-append">
                                                <span class=" input-group-text fas fa-money-bill bg-light"></span>
                                            </div>
                                        </div>
