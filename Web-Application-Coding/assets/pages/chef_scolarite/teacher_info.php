<?php
    ...
    if(!empty($_GET['prof']) and isset($_GET['prof']))
    {
        ...
        else
        {
            ...
            $all_courses = $obj->Select("module m, classe c", [], ["c.ID_CLASSE"=>"m.ID_CLASSE"]);
            $id_driven_courses = [];
            $arr_all_courses = [];
            $arr_classes = [];
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                          ...
                                          <input type="text" name="first_name" id="first_name" class="form-control" value=<?= $prof['NOM_PROF']?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                          ...
                                          <input type="text" name="last_name" id="last_name" class="form-control" value=<?= $prof['PRENOM_PROF']?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group my-3">
                                          ...
                                          <input type="email" name="email" id="email" class="form-control" value="<?= $prof['EMAIL_PROF']?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group my-3">
                                          ...
                                          <input type="tel" name="phone" id="phone" class="form-control" value="<?= $prof['TELEPHONE_PROF']?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group my-3">
                                          ...
                                          <input type="text" name="cnib" id="cnib" class="form-control" value="<?= $prof['CNIB_PROF']?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group my-3">
                                          ...
                                          <select name="grade" id="grade" class="form-control" value="<?= "Doctorant" ?>">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group my-3">
                                            ...
                                            <textarea type="text" class="form-control" name="speciality" id="speciality"  rows="6" cols="30">
                                            <?= $prof['SPECIALITE']?>
                                            </textarea>
                                        </div>
                                    </div>
