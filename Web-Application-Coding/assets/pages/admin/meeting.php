                        ...
                        <div class="tab-pane fade show active" id="inscription">
                            <form action="" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 p-4">
                                        <label for="inscription_recommend" class="pb-3">Recommendation<span class="text-danger"> * </span></label>
                                        <div class="input-group">
                                            <input type="text" name="inscription_recommend" id="inscription_recommend" class="form-control" placeholder="" required>
                                            <div class="input-group-append">
                                    ...
                                    <!-- Parent Name -->
                                     <div class="col-lg-6 p-4">
                                        <label for="inscription_fath_name" class="pb-3">Father Name<span class="text-danger"> * </span></label>
                                        <div class="input-group">
                                            <input type="text" name="inscription_fath_name" id="inscription_fath_name" class="form-control" placeholder="" required>
                                            <div class="input-group-append">
                                                <span class=" input-group-text fas fa-user bg-light"></span>
                                            </div>
                                        </div>
                                     ...
                                     <!-- Mother Name -->
                                     <div class="col-lg-6 p-4">
                                        <label for="inscription_moth_name" class="pb-3">Mother Name<span class="text-danger"> * </span></label>
                                        <div class="input-group">
                                            <input type="text" name="inscription_moth_name" id="inscription_moth_name" class="form-control" placeholder="" required>
                                            <div class="input-group-append">
                                                <span class=" input-group-text fas fa-user bg-light"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6 p-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="inscription_father_job" id="inscription_father_job" class="form-control" value="" required>
                                            <div class="input-group-append">
                                                <span class=" input-group-text fas fa-user bg-light"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6 p-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="inscription_moth_job" id="inscription_moth_job" class="form-control" value="" required>
                                            <div class="input-group-append">
                                                <span class=" input-group-text fas fa-user bg-light"></span>
                                            </div>
                                        </div>
                                    ...
                                    <!-- <div class="col-lg-4 p-4">
                                        ...
                                        <div class="input-group">
                                            <select class="form-control" name="inscription_scholarship" id="inscription_scholarship">
                                    ...
                                    <!-- Motivation Area -->
                                    <div class="col-lg-6 p-4">
                                        <label for="motivation" class="pb-3">Motivations<span class="text-danger"> * </span></label>
                                        <textarea name="motivation" id="motivation" class="form-control" rows="10" required style="resize:none;"></textarea>
                                    </div>

                                    <!-- Observation Area -->
                                    <div class="col-lg-6 p-4">
                                        <label for="observation" class="pb-3">Observations<span class="text-danger"> * </span></label>
                                        <textarea name="observation" id="observation" class="form-control" rows="10" required style="resize:none;"></textarea>
                                    </div>
