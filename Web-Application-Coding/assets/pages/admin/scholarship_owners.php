        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body py-2">
                    ...
                    <!-- Scholarship Update -->
                    <div class="modal fade" id="update_new_Scolarship" data-backdrop="static" data-keyboard="false" role="dialog" tabindex="-1" aria-hidden="true">
                                            ...
                                            <form action="" method="post" class="my-5">
                                                ...
                                                <input type="text" value="" id="hide_id" hidden> 
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div class="input-group">
                                                            <select  class="form-control" name="" id="taux"> </select>
                                                            <div class="input-group-append">
