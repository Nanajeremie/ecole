                        ...
                        <table id="table" class="table table-bordered table-hover table-responsive-lg table-responsive-md table-responsive-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-truncate">Reduction Rate</th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-truncate"><?= $the_bourse['TAUX'] . ' %'; ?></td>
                                        </tr>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button class="btn btn-danger" name="delete_scholarship" id="delete_scholarship<?= $the_bourse['ID_BOURSE'];?>" type="submit">Delete </button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
