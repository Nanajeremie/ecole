                ...
                <div class="card shadow">
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a href="#inscription" class="nav-link active" id="inscription_tab" data-toggle="tab">Step
                                     : Pre - Inscription</a>
                            </li>
                        </ul>
                    </div>
                                ...
                                <form action="" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 p-4">
                                            <label for="inscription_nom" class="pb-3">First Name<span
                                        ...
                                        <!-- Last Name -->
                                        <div class="col-lg-4 p-4">
                                            <label for="inscription_prenom" class="pb-3">Last Name(s)<span
                                                        class="text-danger"> * </span></label>
                                            <div class=" input-group">
                                        ...
                                        <div class="col-lg-4 p-4">
                                            ...
                                            if (isset($error['cnib_exist'])):
                                                ?>
                                                <div style="display: block" class="alert alert-danger mt-1"
                                                     id="dinscription_cnib"><?= $error['cnib_exist'] ?></div>
                                            <?php
                                            endif;
                                            ?>
                                        </div>
                                        ...
                                        <!-- <div class="col-lg-4 p-4">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="inscription_recommend" id="inscription_recommend" class="form-control" placeholder="">
                                                <div class="input-group-append">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- Coming School -->
                                        <div class="col-lg-4 p-4">
                                            <label for="inscription_school" class="pb-3">Coming School<span
                                                        class="text-danger"> * </span></label>
                                            <div class="input-group">
                                        ...
                                        <!-- Degree Area -->
                                        <div class="col-lg-4 p-4">
                                            <label for="inscription_bac" class="pb-3">Degree<span
                                                        class="text-danger"> * </span></label>
                                            <div class="input-group">
                                                <select class="form-control" name="inscription_bac" id="inscription_bac"
                                                        required>
                                                    <option value="" disabled selected>Select Degree</option>
                                                    <?php while ($bac = $type_bac->fetch()) {
                                        ...
                                        <!-- Desired Degree -->
                                        <div class="col-lg-4 p-4">
                                            <label for="inscription_classe" class="pb-3">Interested Domain<span
                                                        class="text-danger"> * </span></label>
                                            <div class="input-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 p-4">
                                            ...
                                            <div class="input-group">
                                                <input oninput="cacher(this.id)" type="email" name="inscription_email"
                                                       id="inscription_email" class="form-control" placeholder=""
                                            ...
                                            if (isset($error['email_exist'])):
                                                ?>
                                                <div style="display: block" class="alert alert-danger mt-1"
                                                     id="dinscription_email"><?= $error['email_exist'] ?></div>
                                            <?php
                                            endif;
                                            ?>
                                        </div>
                                        ...
                                        <!-- Phone Number -->
                                        <div class="col-lg-4 p-4">
                                            <label for="inscription_tel" class="pb-3">Phone Number<span
                                                        class="text-danger"> * </span></label>
                                            <div class="input-group">
                                        ...
                                        <!-- Emergency Number -->
                                        <div class="col-lg-4 p-4">
                                            <label for="inscription_tel_urg" class="pb-3">Emergency Number<span
                                                        class="text-danger"> * </span></label>
                                            <div class="input-group">
