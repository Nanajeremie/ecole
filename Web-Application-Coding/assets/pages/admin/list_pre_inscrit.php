<?php
    ...
    //var_dump($all_new_student->fetchAll());
                                            ...
                                            <tr>
                                                <td class="text-truncate">
                                                    <div class="btn-group" role="group" aria-label="Button group">
                                                        <button onclick="rename_input_update(this.title)" class="btn text-truncate"
                                                                title="<?= $new_student['ID_NEW_ETUDIANT']; ?>" data-toggle="modal"
                                                                data-target="<?= '#' . $update ?>"><i
                                                                    class="fas fa-edit text-warning"></i></button>
                                                        <button onclick="rename_input_delete(this.title)"
                                                                title="<?= $new_student['ID_NEW_ETUDIANT']; ?>" class="btn text-truncate"
                                                            ...
                                                            <div class="container-fluid">
                                                                <form action="" method="post">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <!-- Degree Area-->
                                                                        <div class="col-lg-4 p-4">
                                                                            <label for="<?= 'inscription_bac' . $new_student['ID_NEW_ETUDIANT'] ?>"
                                                                                class="pb-3">Degree<span
                                                                                        class="text-danger"> * </span></label>
                                                                            <div class="input-group">
                                                                                <input type="text"
                                                                        ...
                                                                        <!-- Desired Degree-->
                                                                        <div class="col-lg-4 p-4">
                                                                            <label for="<?= 'inscription_classe' . $new_student['ID_NEW_ETUDIANT'] ?>"
                                                                                class="pb-3">Interested Domain<span
                                                                                        class="text-danger"> * </span></label>
                                                                            <div class="input-group">
                                                                                <select class="form-control"
                                                                        ...
                                                                        <div class="col-lg-4 p-4">
                                                                            <label for="<?= 'inscription_email' . $new_student['ID_NEW_ETUDIANT'] ?>"
                                                                                class="pb-3">Email<span
                                                                                        class="text-danger"> * </span></label>
                                                                            <div class="input-group">
                                                                                <input type="email"
                                                                        ...
                                                                        <!-- Phone Number-->
                                                                        <div class="col-lg-4 p-4">
                                                                            <label for="<?= 'inscription_tel' . $new_student['ID_NEW_ETUDIANT'] ?>"
                                                                                class="pb-3">Phone Number<span
                                                                                        class="text-danger"> * </span></label>
                                                                            <div class="input-group">
                                                                                <input type="number"
                                                                        ...
                                                                        <!-- Emergency Number  -->
                                                                        <div class="col-lg-4 p-4">
                                                                            <label for="<?= 'inscription_tel_urg' . $new_student['ID_NEW_ETUDIANT'] ?>"
                                                                                class="pb-3">Emergency Number<span
                                                                                        class="text-danger"> * </span></label>
                                                                            <div class="input-group">
                                                                                <input type="number"
                                                                        ...
                                                                        <div class="col-lg-12 text-center my-5">
                                                                            ...
                                                                            <button class="btn btn-success w-25 my-3"
                                                                                    name="update_student_infos">update
                                                                            </button>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="container-fluid">
                                                                    ...
                                                                    : <?= $new_student["NOM"]." ".$new_student["PRENOM"] ?>
                                                                </div>
                                                            </div>
