<?php 
    ...
    if (isset($_POST['submit_student_fees']))
    {
        ...
        $obj->Insert('historique_payement', array('ID_INSCRIPTION', 'MONTANT', 'DATE_PAYEMENT'), array($old_student['ID_INSCRIPTION'], $inscription_payment, 'NOW()'));
        $_SESSION['other_pay'] = 1;

        Redirect('recu.php?firstname='.$old_student["NOM"] .'&lastname='.$old_student["PRENOM"]);
        //Redirect('valide_other_paiement.php');
    }
    include('header.php');
?>
