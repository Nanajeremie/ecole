<?php
    ...
    if (isset($_POST['submit_meeting_info'])) {
        ...
        Redirect('attribute_scholarship.php');
    }
            ...
            <div class="card shadow">
                <div class="card-header">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a href="#inscription" class="nav-link active" id="inscription_tab" data-toggle="tab">Step : Attribute scholarship</a>
                        </li>
                    </ul>
                </div>
                            ...
                            <form action="" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 p-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="inscription_recommend" id="inscription_recommend" class="form-control" value="<?= $the_new_student['RECOMMENDATION'] ?>" placeholder="" readonly>
                                            <div class="input-group-append">
                                    ...
                                    <div class="col-lg-6 p-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="inscription_fath_name" id="inscription_fath_name" class="form-control" value="<?= $the_new_student['NOM_PERE']; ?>" placeholder="" readonly>
                                            <div class="input-group-append">
                                                <span class=" input-group-text fas fa-user bg-light"></span>
                                            </div>
                                        </div>
                                     ...
                                     <div class="col-lg-6 p-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="inscription_moth_name" id="inscription_moth_name" class="form-control" value="<?= $the_new_student['NOM_MERE']; ?>" placeholder="" readonly>
                                            <div class="input-group-append">
                                                <span class=" input-group-text fas fa-user bg-light"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6 p-4">
                                        ...
                                        <textarea name="motivation" id="motivation" class="form-control" rows="10"  style="resize:none;" readonly><?= $the_new_student['MOTIVATION']; ?></textarea>
                                    </div>

                                    <!-- Observation Area -->
                                    <div class="col-lg-6 p-4">
                                        <label for="observation" class="pb-3">Observations</label>
                                        <textarea name="observation" id="observation" class="form-control" rows="10"  style="resize:none;" readonly><?= $the_new_student['OBSERVATION']; ?></textarea>
                                    </div>
